    ...
    [1], {
        ...
        "3c0d6": function(t, e, a) {
            ...
            var s = function() {
                    var t = this,
                        e = t.$createElement,
                        a = t._self._c || e;
                    return a("q-card", t._b({ staticClass: "box-burn" }, "q-card", t.$attrs, !1), [a("q-toolbar", [a("q-toolbar-title", [a("div", { staticClass: "text-h6" }, [t._v(t._s(t.$t("Automatic Hyper Burn")))])]), a("q-btn", { attrs: { round: "", dense: "", icon: "help", type: "a", href: "https://docs.libero.financial/automatic-hyper-burn", target: "_blank" } })], 1), a("q-card-section", [a("q-list", { staticClass: "rounded-borders bg-blue-grey-10 q-mb-sm" }, [a("q-item", [a("q-item-section", [a("q-item-label", [t._v(t._s(t.$t("Total burned")))])], 1), a("q-item-section", { staticClass: "text-right text-white", attrs: { side: "" } }, [t.tokenInfo.totalBurned ? [a("q-item-label", { staticClass: "text-green text-h5" }, [t._v("$" + t._s(parseFloat(t.tokenInfo.totalBurnedFiat.toFixed(2)).toLocaleString()) + " ")]), a("q-item-label", { staticClass: "text-grey-5", attrs: { lines: "2" } }, [t._v("( " + t._s(parseFloat(t.tokenInfo.totalBurned.toFixed(2)).toLocaleString()) + " FEFE )")]), a("q-item-label", { staticClass: "text-grey-5", attrs: { lines: "2" } }, [t._v("( " + t._s(parseFloat(t.totalBurnSupply.toFixed(2)).toLocaleString()) + "% total supply )")])] : t._e()], 2)], 1)], 1), a("q-list", { staticClass: "rounded-borders bg-blue-grey-10 q-mb-sm" }, [a("q-item", [a("q-item-section", [a("q-item-label", [t._v(t._s(t.$t("Next burn amount")))])], 1), a("q-item-section", { staticClass: "text-right text-white", attrs: { side: "" } }, [t.tokenInfo.nextBurnAmount ? [a("q-item-label", { staticClass: "text-green text-h5" }, [t._v("$" + t._s(parseFloat(t.tokenInfo.nextBurnAmountFiat.toFixed(2)).toLocaleString()))]), a("q-item-label", { staticClass: "text-grey-5", attrs: { lines: "2" } }, [t._v("( " + t._s(parseFloat(t.tokenInfo.nextBurnAmount.toFixed(2)).toLocaleString()) + " FEFE )")])] : t._e()], 2)], 1)], 1), a("q-list", { staticClass: "rounded-borders bg-blue-grey-10 q-mb-sm" }, [a("q-item", [a("q-item-section", [a("q-item-label", [t._v(t._s(t.$t("Next burn")))])], 1), a("q-item-section", { staticClass: "text-right text-white", attrs: { side: "" } }, [a("q-item-label", [a("countdown-burn")], 1)], 1)], 1)], 1), a("q-list", { staticClass: "rounded-borders bg-blue-grey-10 q-mb-sm" }, [a("q-item", [a("q-item-section", [a("q-item-label", [t._v(t._s(t.$t("Your share/Marketcap")))])], 1), a("q-item-section", { staticClass: "text-right text-white", attrs: { side: "" } }, [a("q-item-label", ["" === t.tokenInfo.balanceFiat ? a("q-skeleton", { attrs: { type: "text", width: "100px" } }) : a("span", { staticClass: "text-green" }, [t._v("$" + t._s((100 * t.tokenInfo.balanceFiat / t.tokenInfo.marketCap).toFixed(5)) + "%")])], 1)], 1)], 1)], 1)], 1)], 1)
                },
                i = [],
                r = (a("e9c4"), a("2f62")),
                o = function() {
        ...
        7367: function(t, e, a) {
            ...
            var c = {
                    ...
                    data() { return { myChart: {}, chartLayout: { textColor: "#d1d4dc", backgroundColor: "#090d27", ...this.layout }, chartData: this.cData, chartSeries: {}, chartAreaOptions: { topColor: "rgba(38, 198, 218, 0.56)", bottomColor: "rgba(38, 198, 218, 0.04)", lineColor: "rgba(38, 198, 218, 1)", lineWidth: 2, crossHairMarkerVisible: !1, title: this.$t("FEFE Insurance Treasury"), ...this.areaOptions }, chartDataTax: this.cDataTax, chartSeriesTax: {}, chartAreaOptionsTax: { topColor: "rgba(234,153,153, 0.56)", bottomColor: "rgba(234,153,153, 0.14)", lineColor: "rgba(234,153,153, 1)", lineWidth: 2, crossHairMarkerVisible: !1, title: this.$t("FEFE Insurance Treasury") }, chartDataBuyBack: this.cDataBuyBack, chartSeriesBuyBack: {}, chartAreaOptionsBuyBack: { topColor: "rgba(234,153,12, 0.56)", bottomColor: "rgba(234,153,153, 0.14)", lineColor: "rgba(234,153,12, 1)", lineWidth: 2, crossHairMarkerVisible: !1, title: this.$t("FEFE Insurance Treasury") }, chartDataProfit: this.cDataProfit, chartLineOptionsProfit: { lineWidth: 2, color: "rgba(23,255,12, 1)", crossHairMarkerVisible: !1, title: this.$t("Profit") }, chartSeriesProfit: {} } },
                    mounted() {
                        let t = this;
                ...
                r = {
                    ...
                    computed: {
                        ...
                        displayList() {
                            ...
                            for (let a = 0; a < e.length; a++) t.push({ id: e[a], url: "https://www.youtube.com/embed/" + e[a], thumb: "https://img.youtube.com/vi/" + e[a] + "/sddefault.jpg" });
                            return t
                        }
                    },
